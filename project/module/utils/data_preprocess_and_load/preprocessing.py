...
def main():
    ...
    dataset_name = 'WM_nback'
    load_root = '/scratch/alpine/alar6830/WM_nback_labels/' # This folder should have fMRI files in nifti format with subject names. Ex) sub-01.nii.gz 
